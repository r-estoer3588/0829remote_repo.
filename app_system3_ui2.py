...
def display_drop3d_ranking(
    ...
    years: int = 5,
    top_n: int = 100,
    title: str = "投 System3 譌･蛻･ 3譌･荳玖誠邇・繝ｩ繝ｳ繧ｭ繝ｳ繧ｰ・育峩霑捜years}蟷ｴ / 荳贋ｽ砿top_n}驫俶氛・・,
):
    if not candidates_by_date:
        st.warning("3譌･荳玖誠邇・Λ繝ｳ繧ｭ繝ｳ繧ｰ縺檎ｩｺ縺ｧ縺・)
        return
    rows = []
...
def run_tab(ui_manager=None):
    st.header("System3・懊Ο繝ｳ繧ｰ繝ｻ繝溘・繝ｳ繝ｪ繝舌・繧ｸ繝ｧ繝ｳ・医そ繝ｫ繧ｪ繝慕漁縺・ｼ・)
